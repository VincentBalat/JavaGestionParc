...
public class ErreurBD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Erreur dans la base de donnée");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErreurBD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
